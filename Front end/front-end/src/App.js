...
import Reference18 from './pages/references/Reference18';
import Reference19 from './pages/references/Reference19';
    ...
    <Router>
      <div>
        ...
        <Routes>
          ...
          <Route path="reference18" element={<Reference18 />} />
          <Route path="reference19" element={<Reference19 />} />
        </Routes>
      </div>
    </Router>
  );
